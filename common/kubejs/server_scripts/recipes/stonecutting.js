ServerEvents.recipes(event => {
  ...
  add('industrial_grating_panel_from_industrial_grating', 'bits_n_bobs:industrial_grating', 'bits_n_bobs:industrial_grating_panel', 4)
  add('industrial_grating_panel_from_industrial_iron_block', 'create:industrial_iron_block', 'bits_n_bobs:industrial_grating_panel', 4)
  add('industrial_grating', 'create:industrial_iron_block', 'bits_n_bobs:industrial_grating', 1)
