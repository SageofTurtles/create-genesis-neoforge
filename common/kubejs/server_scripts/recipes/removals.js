...
ServerEvents.recipes(event => {
  ...
  id(/^railways:crafting\/palettes\/hazard_stripes_b\/.*/)
  ...
  output('bits_n_bobs:industrial_grating_panel')
  output('bits_n_bobs:industrial_grating')
